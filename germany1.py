...
class Germany():
    def __init__(self, termin, category, vc_type):
        ...
        ud = [{
            'id': '1',
            'vc_status': '2',
            'vc_city': 'Schengenvisa',
            'vc_type': 'Inviting',
            'vc_passport': 'PD0050699',
            'vc_birth': '1985-06-21',
            'vc_passport_from': '2022-10-13',
            'vc_passport_to': '2032-10-13',
            'vc_passport_by': 'MIA',
            'vc_name': 'VITALI',
            'vc_surname': 'ASTASHKEVICH',
            'vc_phone': '+375293875177',
            'vc_date_first_travel': '2023-01-10',
            'vc_date_from': '2022-09-20',
            'vc_date_to': '2024-01-10',
            'vc_with': '0',
            'vc_comment': '|viktor_gurov@internet.ru|',
            'vc_first': '0',
            'vc_today': '0',
            'vc_before_visit': '0',
            'vc_mail': '3875177@GMAIL.COM',
            'vc_inviting': 'Andreas Moor',
            'vc_inviting_address': ''
        }, {
            'id': '2',
            'vc_status': '2',
            'vc_city': 'Schengenvisa',
            'vc_type': 'Inviting',
            'vc_passport': '550493832',
            'vc_birth': '1988-04-03',
            'vc_passport_from': '2021-03-03',
            'vc_passport_to': '2031-03-03',
            'vc_passport_by': 'MIA',
            'vc_name': 'ALEKSANDRA',
            'vc_surname': 'ASTASHKEVICH',
            'vc_phone': '+375293875177',
            ...
            'vc_city': 'Schengenvisa',
            'vc_type': 'Inviting',
            'vc_passport': 'MP4344130',
            'vc_birth': '2012-12-05',
            'vc_passport_from': '2019-04-30',
            'vc_passport_to': '2024-04-30',
            'vc_passport_by': 'MIA',
            'vc_name': 'ARSENI',
            'vc_surname': 'ASTASHKEVICH',
            'vc_phone': '+375293875177',
            ...
            'vc_city': 'Schengenvisa',
            'vc_type': 'Inviting',
            'vc_passport': 'MP4280754',
            'vc_birth': '2015-06-11',
            'vc_passport_from': '2018-12-18',
            'vc_passport_to': '2023-12-18',
            'vc_passport_by': 'MIA',
            'vc_name': 'NIKITA',
            'vc_surname': 'ASTASHKEVICH',
            'vc_phone': '+375293875177',
            ...
            'vc_city': 'Schengenvisa',
            'vc_type': 'Inviting',
            'vc_passport': 'MP4772968',
            'vc_birth': '2017-07-28',
            'vc_passport_from': '2022-07-08',
            'vc_passport_to': '2027-07-08',
            'vc_passport_by': 'MIA',
            'vc_name': 'DARYA',
            'vc_surname': 'ASTASHKEVICH',
            'vc_phone': '+375293875177',
        ...
        self.users_dict = [u for u in ud if u['vc_type'] == 'Inviting']
